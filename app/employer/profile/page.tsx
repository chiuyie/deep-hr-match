  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-100 bg-gradient-to-r from-slate-50 to-white px-5 py-4 shadow-sm">
        <h2 className="text-lg font-semibold text-slate-800 sm:text-xl">Employer Profile</h2>
      ...
      <EmployerPageSection
        ...
        description="Employer details used across your job postings and candidate interactions"
