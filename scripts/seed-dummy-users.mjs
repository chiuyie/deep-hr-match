...
const dummyCandidates = [
  {
    ...
    profile: {
      ...
      custom_fields: {
        ...
        // Optional matching attributes (so employers can use them without empty failures)
        age_range: "26-30",
        ethnicity: "Chinese",
